 ...
 */
public class DeleteDmeDevicesAPI {
	...
	public HashMap<String, String> deleteDMEdevice(HashMap<String, String> apiresponse ) {
		String responseFlag = null;
		try {
			client = Client.create();
			webResource = client.resource(apiresponse.get(IAPIConstantCodes.APIResponseBaseUrl))
					     .path(RevbaseAPIURLs.DELETEDMEURL+apiresponse.get(IAPIConstantCodes.DEVICEID));
	...
	public HashMap<String, String> deleteDMEdevicewithoutauthorization(HashMap<String, String> apiresponse ) {
		String responseFlag = null;
		try {
			client = Client.create();
			webResource = client.resource(apiresponse.get(IAPIConstantCodes.APIResponseBaseUrl))
