...
public class ZonesListAPI {
	private static Logger logger = Logger.getLogger(ZonesListAPI.class);
	...
	public HashMap<String, String> getZonedevices(HashMap<String, String> apiresponse) {
	...
	public HashMap<String, String> getZonesID(HashMap<String, String> apiresponse) {
