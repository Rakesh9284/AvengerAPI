...
public class DeleteEmbeddedContent_AV28828 extends TestBase {
	private static Logger logger = Logger.getLogger(DeleteEmbeddedContent_AV28828.class);
	...
	@Test(description="To Verify and create a new webcast and delete Embedded content file (Delete Shared URL)",groups = {DELETEEmbeddedContentWebcast})
	public void TC01_Createanew_DeleteSharedURL_DELETEEmbeddedContentWebcast_Positve_AV28828(ITestContext context)
	{
		...
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get("Statuscode").toString(), HttpStatusCode.httpsStatusCode200);
		 ...
		 //EventAdminId String
		  ...
		  ArrayList<String> deleteembeddedcontentAPIresponse=embeddedcontentAPI.Delete_EmbeddedContentAPI(loginapiresponse1);
		  assertionapiresponse.verifyAssert_httpCode(deleteembeddedcontentAPIresponse.get(0).toString(), HttpStatusCode.httpsStatusCode200);
		  customReport.customizedReport(HttpStatusCode.httpsStatusCode200,deleteembeddedcontentAPIresponse.get(0).toString(),statusValue, driver, sTestcaseName);
		  ...
		  launchURL(surl);
	        ...
	        //it is scrolling down just to verify the embedded content is deleted or not
	...
	@Test(description="To Verify and create a new webcast and delete multiple embeddedcontent file with  sharedurlid (Delete Shared URL)",groups = {DELETEEmbeddedContentWebcast})
	public void TC02_Createanew_Delete_MultipleSharedURL_Multiplesharedurlid_Positive_AV28828(ITestContext context)
	{
		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		  ...
		  int i;
		   ...
		   //selenium code
			  launchURL(surl);
		        ...
		        avengerEventdetailsbeanpage.setTitle(createEventBean.getTitle()); 
		        avengereventdetailspage=avengereventspage.clickCreatedEvent(avengerEventdetailsbeanpage);
		        //it is scrolling down just to verify the push contents is deleted or not
		        avengereventspage.scroll_embeddedcontent();	
		        customReport.checkinglist(statusValue);
	...
	@Test(description="To Verify and create a new webcast and delete embeddedcontent file with invalid sharedurlid (Delete Shared URL)",groups = {DELETEEmbeddedContentWebcast})
	public void TC03_Createanew_DeleteSharedURL_Invalidsharedurlid_Negative_AV28786(ITestContext context)
	{
		...
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get("Statuscode").toString(), HttpStatusCode.httpsStatusCode200);
		 ...
		 customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get("Statuscode").toString(),statusValue, driver, sTestcaseName);
		  ...
		  ArrayList<String> deleteembeddedcontentAPIresponse=embeddedcontentAPI.Delete_EmbeddedContentAPI(loginapiresponse1);
		  assertionapiresponse.verifyAssert_httpCode(deleteembeddedcontentAPIresponse.get(0).toString(), HttpStatusCode.httpsStatus401);
		  customReport.customizedReport(HttpStatusCode.httpsStatus401,deleteembeddedcontentAPIresponse.get(0).toString(),statusValue, driver, sTestcaseName);
	...
	@Test(description="To Verify and create a new webcast and delete embeddedcontent file as media viewer (Delete Shared URL)",groups = {DELETEEmbeddedContentWebcast})
	public void TC04_Createanew_DeleteSharedURL_AsMediaviewer_Negative_AV28828(ITestContext context)
	{
		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		...
		//EventAdminId String
		  ...
		  JSONObject loginapiresponse = userservices.doLoginUpdate(apiutils.userJson(IUsersList.DeleteEmbedded_Mediaviewer), surl);
			assertionapiresponse.verifyAssert_httpCode(loginapiresponse.get("Statuscode").toString(), HttpStatusCode.httpsStatusCode200);
			 ...
			 loginapiresponse.put(IAPIConstantCodes.SharedURLID,embeddedcontentAPIresponse.get("id"));
			 
		  ArrayList<String> deleteembeddedcontentAPIresponse=embeddedcontentAPI.Delete_EmbeddedContentAPI(loginapiresponse);
		  assertionapiresponse.verifyAssert_httpCode(deleteembeddedcontentAPIresponse.get(0).toString(), HttpStatusCode.httpsStatus401);
		  customReport.customizedReport(HttpStatusCode.httpsStatus401,deleteembeddedcontentAPIresponse.get(0).toString(),statusValue, driver, sTestcaseName);
		  customReport.checkinglist(statusValue);
