...
public class MediaContributor_UserCreation_API_1_40 extends TestBase{
	private static Logger logger = Logger.getLogger(MediaContributor_UserCreation_API_1_40.class);
	...
	{	
		...
		homePage = loginPage.loginAs(IEnvSetupService.apigriduser4,IEnvSetupService.apigridpwd);
	...
	public Object[][] userdetails(){
		...
		UserServices userservices = new UserServices();
 		loginapiresponse = userservices.doLogin(apiutils.userJson(IEnvSetupService.apigriduser4), surl);
		...
		AddUserApiBean userbean = new AddUserApiBean();
		bFactory.AddUserBean(userbean);
		userbean.setFirstname(IEnvSetupService.apimideaconstor+i);
		userbean.setUsername(IEnvSetupService.apimideaconstor+i);
		userbean.setLastname(IEnvSetupService.apimideaconstor+i); 
		userbean.setContactemail(IEnvSetupService.apimideaconstor+i+"@gmail.com" ); 		
