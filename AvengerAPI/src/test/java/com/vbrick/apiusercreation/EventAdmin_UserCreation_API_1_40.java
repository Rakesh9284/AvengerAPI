...
public class EventAdmin_UserCreation_API_1_40 extends TestBase{
	private static Logger logger = Logger.getLogger(EventAdmin_UserCreation_API_1_40.class);
	...
	{	
		...
		homePage = loginPage.loginAs(IEnvSetupService.apigriduser2,IEnvSetupService.apigridpwd);
	...
	public Object[][] userdetails(){
		...
		UserServices userservices = new UserServices();
 		loginapiresponse = userservices.doLogin(apiutils.userJson(IEnvSetupService.apigriduser2), surl);
		...
		AddUserApiBean userbean = new AddUserApiBean();
		bFactory.AddUserBean(userbean);
		userbean.setFirstname(IEnvSetupService.apieadmin+i);
		userbean.setUsername(IEnvSetupService.apieadmin+i);
		userbean.setLastname(IEnvSetupService.apieadmin+i); 
		userbean.setContactemail(IEnvSetupService.apieadmin+i+"@gmail.com" ); 		
