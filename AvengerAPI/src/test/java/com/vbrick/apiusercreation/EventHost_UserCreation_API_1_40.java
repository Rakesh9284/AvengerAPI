...
public class EventHost_UserCreation_API_1_40 extends TestBase{
	private static Logger logger = Logger.getLogger(EventHost_UserCreation_API_1_40.class);
	...
	{	
		...
		homePage = loginPage.loginAs(IEnvSetupService.apigriduser6,IEnvSetupService.apigridpwd);
	...
	public Object[][] userdetails(){
		...
		UserServices userservices = new UserServices();
 		loginapiresponse = userservices.doLogin(apiutils.userJson(IEnvSetupService.apigriduser6), surl);
		...
		AddUserApiBean userbean = new AddUserApiBean();
		bFactory.AddUserBean(userbean);
		userbean.setFirstname(IEnvSetupService.apiehadmin+i);
		userbean.setUsername(IEnvSetupService.apiehadmin+i);
		userbean.setLastname(IEnvSetupService.apiehadmin+i); 
		userbean.setContactemail(IEnvSetupService.apiehadmin+i+"@gmail.com" ); 		
