...
public class MediaAdmin_UserCreation_API_1_40 extends TestBase{
	private static Logger logger = Logger.getLogger(MediaAdmin_UserCreation_API_1_40.class);
	...
	{	
		...
		homePage = loginPage.loginAs(IEnvSetupService.apigriduser3,IEnvSetupService.apigridpwd);
	...
	public Object[][] userdetails(){
		...
		Object[][] data = new Object[65][1];
		String user="apiuser";
		
		for(int i=0;i<=64;i++){
		Hashtable<String,String> usernamelist=new Hashtable<String,String>();
		UserServices userservices = new UserServices();
 		loginapiresponse = userservices.doLogin(apiutils.userJson(IEnvSetupService.apigriduser3), surl);
		...
		AddUserApiBean userbean = new AddUserApiBean();
		bFactory.AddUserBean(userbean);
		userbean.setFirstname(IEnvSetupService.apimediaadmin+i);
		userbean.setUsername(IEnvSetupService.apimediaadmin+i);
		userbean.setLastname(IEnvSetupService.apimediaadmin+i); 
		userbean.setContactemail(IEnvSetupService.apimediaadmin+i+"@gmail.com" ); 		
