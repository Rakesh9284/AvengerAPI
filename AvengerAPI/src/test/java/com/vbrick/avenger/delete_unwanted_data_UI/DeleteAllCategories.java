...
public class DeleteAllCategories extends TestBase{

	private static Logger logger = Logger.getLogger(DeleteAllCategories.class);
	...
	public void TC_01_Deleting_All_Categories_From_UI(ITestContext context ) {
		...
		avengergroupspage =avengerHomePage.clickCategoriesLink();
		avengergroupspage =avengerHomePage.deleteAllCategories();
