...
public class DeleteAllChannels extends TestBase{

	private static Logger logger = Logger.getLogger(DeleteAllChannels.class);
	...
	public void TC_01_Deleting_All_Channels_From_UI(ITestContext context ) {
		...
		avengergroupspage =avengerHomePage.deleteAllChannels();
