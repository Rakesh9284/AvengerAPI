...
public class DeleteAllPresentationProfiles extends TestBase{

	private static Logger logger = Logger.getLogger(DeleteAllPresentationProfiles.class);
	...
	@Test(description="To Verify the CreateGroup using CreateGroup API with Account Admin ")
	public void TC_01_Deleting_All_PresentationProfiles_From_UI(ITestContext context ) {
		...
		avengergroupspage =avengerHomePage.deleteAllPresentationProfiles(); 
