...
public class DeleteAllDevices extends TestBase{

	private static Logger logger = Logger.getLogger(DeleteAllDevices.class);
	...
	public void TC_01_Deleting_All_Devices_From_UI(ITestContext context ) {
		...
		avengerDevicesPage = avengerHomePage.click_Devicestab();
		avengergroupspage =avengerHomePage.deleteAllDevices(); 
