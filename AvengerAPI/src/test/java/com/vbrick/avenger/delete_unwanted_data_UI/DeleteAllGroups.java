...
public class DeleteAllGroups extends TestBase{

	private static Logger logger = Logger.getLogger(DeleteAllGroups.class);
	...
	public void TC_01_Deleting_All_Groups_From_UI(ITestContext context ) throws InterruptedException {
		...
		avengergroupspage =avengerHomePage.deleteAllGroups();
