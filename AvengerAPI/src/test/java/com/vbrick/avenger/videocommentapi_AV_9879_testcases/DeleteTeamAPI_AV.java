...
public class DeleteTeamAPI_AV extends TestBase {

	private static Logger logger = Logger.getLogger(DeleteTeamAPI_AV.class);
	...
	@Test(description = "To Verify the DeleteTeam using   API with Account Admin",groups = {DELETETEAMAPI})
	public void TC_01_DELETE_DeletTeam_api_check_With_AccountAdmin_Positive(ITestContext context) {
        ...
        customReport.customizedReport(false, avengerlibrarypage.verify_IsElementdoesnot_exists(librarybeanpage), statusValue, driver, sTestcaseName);  
        customReport.checkinglist(statusValue);
	}
	
	@Test(description = "To Verify the DeleteTeam using DeleteTeam API with Media Admin",groups = {DELETETEAMAPI})
	public void TC_02_DELETE_DeletTeam_api_check_With_MediaAdminPositive(ITestContext context) {
		...
		UserServices userservices_mediaadmin = new UserServices();
 		loginapiresponse_mediaadmin = userservices_mediaadmin.doLogin(apiutils.userJson(IUsersList.DeleteTeammediaadmin), surl);  
		...
		loginapiresponse_mediaadmin.put(IAPIConstantCodes.APIResponseTEAMID, createteamapirespone.get(IAPIConstantCodes.APITEAMID));
		
		// Delete Team
		DeleteTeamAPI deleteTeamAPI = new DeleteTeamAPI();
		deleteTeamapiresponse = deleteTeamAPI.deleteTeams(loginapiresponse_mediaadmin);
		assertionapiresponse.verifyAssert_httpCode(deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo),HttpStatusCode.httpsStatusCode200OK);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200OK,deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	...
	@Test(description = "To Verify the DeleteTeam using DeleteTeam API with Media Contributor",groups = {DELETETEAMAPI})
	public void TC_03_DELETE_DeletTeam_api_check_With_MediaContributor_Negative(ITestContext context) {
		...
		UserServices userservices_mediaadmin = new UserServices();
 		loginapiresponse_mediacontributor = userservices_mediaadmin.doLogin(apiutils.userJson(IUsersList.DeleteTeammediacontributor), surl);  
		...
		loginapiresponse_mediacontributor.put(IAPIConstantCodes.APIResponseTEAMID, createteamapirespone.get(IAPIConstantCodes.APITEAMID));
		
		// Delete Team
		DeleteTeamAPI deleteTeamAPI = new DeleteTeamAPI();
		deleteTeamapiresponse = deleteTeamAPI.deleteTeams(loginapiresponse_mediacontributor);
		assertionapiresponse.verifyAssert_httpCode(deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo),HttpStatusCode.httpStatusCodeInt401null);
		customReport.customizedReport(HttpStatusCode.httpStatusCodeInt401null,deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description = "To Verify the DeleteTeam using DeleteTeam API with EventAdmin",groups = {DELETETEAMAPI})
	public void TC_04_DELETE_DeletTeam_api_check_With_EventAdmin_Negative(ITestContext context) {
		...
		UserServices userservices_mediaadmin = new UserServices();
 		loginapiresponse_eventadmin = userservices_mediaadmin.doLogin(apiutils.userJson(IUsersList.DeleteTeameventadmin), surl);  
		...
		loginapiresponse_eventadmin.put(IAPIConstantCodes.APIResponseTEAMID, createteamapirespone.get(IAPIConstantCodes.APITEAMID));
		
		// Delete Team
		DeleteTeamAPI deleteTeamAPI = new DeleteTeamAPI();
		deleteTeamapiresponse = deleteTeamAPI.deleteTeams(loginapiresponse_eventadmin);
		assertionapiresponse.verifyAssert_httpCode(deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo),HttpStatusCode.httpStatusCodeInt401null);
		customReport.customizedReport(HttpStatusCode.httpStatusCodeInt401null,deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description = "To Verify the DeleteTeam using DeleteTeam API with mediaviewer",groups = {DELETETEAMAPI})
	public void TC_05_DELETE_DeletTeam_api_check_With_MediaViewer_Negative(ITestContext context) {
		...
		UserServices userservices_mediaadmin = new UserServices();
 		loginapiresponse_mediaviewer = userservices_mediaadmin.doLogin(apiutils.userJson(IUsersList.DeleteTeammediaviewer), surl);  
		...
		loginapiresponse_mediaviewer.put(IAPIConstantCodes.APIResponseTEAMID, createteamapirespone.get(IAPIConstantCodes.APITEAMID));
		
		// Delete Team
		DeleteTeamAPI deleteTeamAPI = new DeleteTeamAPI();
		deleteTeamapiresponse = deleteTeamAPI.deleteTeams(loginapiresponse_mediaviewer);
		assertionapiresponse.verifyAssert_httpCode(deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo),HttpStatusCode.httpStatusCodeInt401null);
		customReport.customizedReport(HttpStatusCode.httpStatusCodeInt401null,deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseHttpCode) + deleteTeamapiresponse.get(IAPIConstantCodes.APIResponseStatusInfo), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
