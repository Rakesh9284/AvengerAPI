...
public class UserDetailsWithUserIDApi_AV_9873 extends TestBase {

	private static Logger logger = Logger.getLogger(UserDetailsWithUserIDApi_AV_9873.class);
    ...
    private  HashMap<String, String> userdetailapirespone;
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with accountadmin",groups = {GETUSERDETAILS_USERID})
	public void TC_01_GET_UserDetail_api_check_UserDetail_with_AccoutAdmin_Positive() {
		...
		loginapiresponse.put(IAPIConstantCodes.APIResponseUSERID1, loginapiresponse.get(IAPIConstantCodes.APIResponseUSERID));		
		UserDetailsAPI userDetailsAPI=new UserDetailsAPI();
		HashMap<String, String> userdetailapirespone = userDetailsAPI.getUserDetails(loginapiresponse);
		...
		adduserbean.setFirstname(userdetailapirespone.get(IUserAccountsService.FIRSTNAME));
		adduserbean.setLastname(userdetailapirespone.get(IUserAccountsService.LASTNAME));
		adduserbean.setUsername(userdetailapirespone.get(IUserAccountsService.USERNAME));
		adduserbean.setContactemail(userdetailapirespone.get(IUserAccountsService.CONTACTEMAIL));
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with Mediaadmin",groups = {GETUSERDETAILS_USERID})
	public void TC_02_GET_UserDetail_api_check_UserDetail_with_MediaAdmin_Positive() {

		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		
		//deleting the assigned groups if any for the Media Viewer user
		delete_assignedGroupsForUser(IUsersList.UserDetailsmediaadmin);
		...
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailsmediaadmin), surl);
		...
		loginapiresponse.put(IAPIConstantCodes.APIResponseUSERID1, loginapiresponse1.get(IAPIConstantCodes.APIResponseUSERID));			
		UserDetailsAPI userDetailsAPI=new UserDetailsAPI();
	    HashMap<String, String> userdetailapirespone = userDetailsAPI.getUserDetails(loginapiresponse);
	    assertionapiresponse.verifyAssert_httpCode(userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode)+userdetailapirespone.get(IAPIConstantCodes.APIResponseStatusInfo), HttpStatusCode.httpsStatusCode200OK);
	    customReport.customizedReport(HttpStatusCode.httpsStatusCode200OK, userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode)+userdetailapirespone.get(IAPIConstantCodes.APIResponseStatusInfo),statusValue, driver, sTestcaseName);
	    
	    String fromattedJSON=apiutils.formatingapiresponse(userdetailapirespone.get(IAPIConstantCodes.APIResponseJSON2));
		ArrayList<String> apiGroupList = new ArrayList<String>(Arrays.asList(fromattedJSON.split(",")));
			
		String fromattedJSON1=apiutils.formatingapiresponse(userdetailapirespone.get(IAPIConstantCodes.APIResponseJSON3));
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with mediacontributor",groups = {GETUSERDETAILS_USERID})
	public void TC_03_GET_UserDetail_api_check_UserDetail_with_MediaContributor_Positive() {
		...
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailsmediacontributor), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
	    ...
	    String fromattedJSON=apiutils.formatingapiresponse(userdetailapirespone.get(IAPIConstantCodes.APIResponseJSON1));
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with eventadmin",groups = {GETUSERDETAILS_USERID})
	public void TC_04_GET_UserDetail_api_check_UserDetail_with_Eventadmin_Positive() {
		...
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailseventadmin), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		...
		ArrayList<String> uiRolelist = avengereditrootaccountpage.get_allassignedroles();
		ArrayList<String> uiRolelist1 = new ArrayList<String>();
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with mediaviewer",groups = {GETUSERDETAILS_USERID})
	public void TC_05_GET_UserDetail_api_check_UserDetail_with_MediaViewer_Positive() {

		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		
		//deleting the assigned groups if any for the Media Viewer user
		delete_assignedGroupsForUser(IUsersList.UserDetailsmediaviewer);
		...
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailsmediaviewer), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		logger.info("Login API response Code :::" + loginapiresponse1);
	...
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with InvalidUserId",groups = {GETUSERDETAILS_USERID})
	public void TC_06_GET_UserDetail_api_check_UserDetail_with_InvalidUserId_Negative() {

		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
					
		UserServices userservices = new UserServices();
		loginapiresponse = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailsmediaviewer), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		logger.info("Login API response Code :::" + loginapiresponse);
		
		loginapiresponse.put(IUserAccountsService.USERID, IUserAccountsService.INVALIDUSERID);
		
		UserDetailsAPI userDetailsAPI=new UserDetailsAPI();
	    HashMap<String, String> userdetailapirespone = userDetailsAPI.getUserDetails(loginapiresponse);
	    assertionapiresponse.verifyAssert_httpCode(userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatus404);
	    customReport.customizedReport(HttpStatusCode.httpsStatus404, userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
	    customReport.checkinglist(statusValue);
	}
	
	@Test(description = "To verify UserDetail   to spicific user using UserDetail API with eventhost",groups = {GETUSERDETAILS_USERID})
	public void TC_07_GET_UserDetail_api_check_UserDetail_with_Eventhost_Positive() {

		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		
		//deleting the assigned groups if any for the Media Viewer user
		delete_assignedGroupsForUser(IUsersList.UserDetailseventhost1);
		...
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailseventhost1), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		logger.info("Login API response Code :::" + loginapiresponse1);
	...
	@Test(description = "To verify UserId  to specific Event Host user using UserId API with Event Admin",groups = {GETUSERDETAILS_USERID})
	public void TC_08_GET_UserId_api_check_UserId_with_EventAdmin_Negative() {

		logger.info("API Level Code is excuting");
		sTestcaseName = new Object() {}.getClass().getEnclosingMethod().getName();
		
		UserServices userservices = new UserServices();
		loginapiresponse = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailseventadmin), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		logger.info("Login API response Code :::" + loginapiresponse);
		
		loginapiresponse1 = userservices.doLogin(apiutils.userJson(IUsersList.UserDetailseventhost), surl);
		assertionapiresponse.verifyAssert_httpCode(loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, loginapiresponse1.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
		logger.info("Event Host Login API response Code :::" + loginapiresponse1);
		
		loginapiresponse.put(IAPIConstantCodes.APIResponseUSERID1, loginapiresponse1.get(IAPIConstantCodes.APIResponseUSERID));
		
		UserDetailsAPI userDetailsAPI=new UserDetailsAPI();
	    HashMap<String, String> userdetailapirespone = userDetailsAPI.getUserDetails(loginapiresponse);
	    assertionapiresponse.verifyAssert_httpCode(userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatus401);
	    customReport.customizedReport(HttpStatusCode.httpsStatus401, userdetailapirespone.get(IAPIConstantCodes.APIResponseHttpCode),statusValue, driver, sTestcaseName);
	    customReport.checkinglist(statusValue);		
				
	}

	@Test(description = "To verify UserDetails with user id and Get user profile image api ",groups = {GETUSERDETAILS_USERID})
	public void TC_09_GET_UserDetails_withUserID_andGetUserImage_Api_with_AccountAdmin_Positive(ITestContext context) throws Exception {
	    ...
	    URI  uri = new URI(userdetailapirespone.get(IAPIConstantCodes.profileImageUri).toString());  
        // get the  Path
