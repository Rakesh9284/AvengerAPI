...
import com.vbricks.avenger.service.IDownloadTranscriptionFile;
...
import com.vbricks.avenger.serviceimpl.DownloadTranscriptionFileAPI;
...
public class DownloadTranscriptionFile_AV_28324 extends TestBase {

	private static Logger logger = Logger.getLogger(DownloadTranscriptionFile_AV_28324.class);
	...
	@Test(description = " To Download Transcription File of a specific video using GET Download Video Transcription File API by accountadmin",groups = {DOWNLOADTRANS_FILEAPI})
	public void TC_01_Download_TranscriptionFile_OfaVideo_AccountAdmin() throws InterruptedException {
		...
		getVideoTranscriptionFiles.put(IAPIConstantCodes.APIResponseVIDEOID, uploadvidoeapiresponse.get(IAPIConstantCodes.APIResponseVIDEOID));
		DownloadTranscriptionFileAPI downloadTranscriptionFileAPI = new DownloadTranscriptionFileAPI();
		HashMap<String, String> downloadtranscriptionfileaApiresponse = downloadTranscriptionFileAPI.downloadTranscriptionFile(getVideoTranscriptionFiles);
		assertionapiresponse.verifyAssert_httpCode(downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode) ,statusValue, driver, sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description = " To Download Transcription File of a specific video with Only View Rights using GET Download Transcription File API by Media Viewer",groups = {DOWNLOADTRANS_FILEAPI})
	public void TC_02_Download_TranscriptionFile_WithOnlyViewAccess_POSITIVE() throws InterruptedException {
       ...
       //Download Transcription File
		getVideoTranscriptionFiles.put(IAPIConstantCodes.APIVIDEOID, uploadvidoeapiresponse.get(IAPIConstantCodes.APIVIDEOID));
		DownloadTranscriptionFileAPI downloadTranscriptionFileAPI = new DownloadTranscriptionFileAPI();
		HashMap<String, String> downloadtranscriptionfileaApiresponse = downloadTranscriptionFileAPI.downloadTranscriptionFile(getVideoTranscriptionFiles);
		assertionapiresponse.verifyAssert_httpCode(downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatusCode200);
		customReport.customizedReport(HttpStatusCode.httpsStatusCode200, downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode) ,statusValue, driver, sTestcaseName);
	...
	@Test(description = " To Download Transcription File of a specific video using GET Download Video Transcription File API by giving INVALID VIDEOID by accountadmin",groups = {DOWNLOADTRANS_FILEAPI})
	public void TC_03_Download_TranscriptionFile_OfaVideo_with_INVALID_VIDEOID_AccountAdmin() throws InterruptedException {
		...
		//Download Transcription File
		getVideoTranscriptionFiles.put(IAPIConstantCodes.APIResponseVIDEOID, IDownloadTranscriptionFile.invalidVideoId);
		DownloadTranscriptionFileAPI downloadTranscriptionFileAPI = new DownloadTranscriptionFileAPI();
		HashMap<String, String> downloadtranscriptionfileaApiresponse = downloadTranscriptionFileAPI.downloadTranscriptionFile(getVideoTranscriptionFiles);
		assertionapiresponse.verifyAssert_httpCode(downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatus401);
		customReport.customizedReport(HttpStatusCode.httpsStatus401, downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode) ,statusValue, driver, sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description = " To Download Transcription File of a specific video using GET Download Video Transcription File API by giving INVALID Transcription File ID by accountadmin",groups = {DOWNLOADTRANS_FILEAPI})
	public void TC_04_Download_TranscriptionFile_OfaVideo_with_INVALID_TranscriptionFile_AccountAdmin() throws InterruptedException {
		...
		//Download Transcription File
		getVideoTranscriptionFiles.put(IAPIConstantCodes.languageId, IDownloadTranscriptionFile.transcriptionfileId);
		DownloadTranscriptionFileAPI downloadTranscriptionFileAPI = new DownloadTranscriptionFileAPI();
		HashMap<String, String> downloadtranscriptionfileaApiresponse = downloadTranscriptionFileAPI.downloadTranscriptionFile(getVideoTranscriptionFiles);
		assertionapiresponse.verifyAssert_httpCode(downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode), HttpStatusCode.httpsStatus401);
		customReport.customizedReport(HttpStatusCode.httpsStatus401, downloadtranscriptionfileaApiresponse.get(IAPIConstantCodes.APIResponseHttpCode) ,statusValue, driver, sTestcaseName);
