...
public class SanityUserCreationfrom1_10 extends TestBase{
	private static Logger logger = Logger.getLogger(SanityUserCreationfrom1_10.class);
...
//	@Test(description="Creation of Users from 130  to 130",invocationCount=11)
	...
	{	
		...
		homePage = loginPage.loginAs("griduser12","Password@123");
	...
	@Test(description="Creation of Sanity User 1")
	public void AT_verify_SanityuserCreation_1() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"1");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 2")
	public void AT_verify_SanityuserCreation_2() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"2");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 3")
	public void AT_verify_SanityuserCreation_3() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"3");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 4")
	public void AT_verify_SanityuserCreation_4() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"4");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 5")
	public void AT_verify_SanityuserCreation_5() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"5");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
		
	@Test(description="Creation of Sanity User 6")
	public void AT_verify_SanityuserCreation_6() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"6");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 7")
	public void AT_verify_SanityuserCreation_7() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"7");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 8")
	public void AT_verify_SanityuserCreation_8() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"8");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 9")
	public void AT_verify_SanityuserCreation_9() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER+"9");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 10")
	public void AT_verify_SanityuserCreation_10() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
//		SANITYUSER.replace("0", "");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER2+"10");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 11")
	public void AT_verify_SanityuserCreation_11() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER2+"11");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
	
	@Test(description="Creation of Sanity User 12")
	public void AT_verify_SanityuserCreation_12() 
	{	
		sTestcaseName = new Object(){}.getClass().getEnclosingMethod().getName();

		customReport.reporter("Application launch with URL : ", surl);
		homePage = loginPage.loginAs("griduser2","Password@123");
		userCreationUtility.gridUserCreation(homePage,adduserbeanpage,avengeradduserpage, SANITYUSER2+"12");
		customReport.customizedReport(adduserbeanpage.getUsername(),homePage.verify_userName(adduserbeanpage.getUsername()), statusValue, driver,sTestcaseName);
		customReport.checkinglist(statusValue);
	}
